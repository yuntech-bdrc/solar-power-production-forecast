...
#                                           target_day_time['lat'].values,
                                          ...
                                          target_day_time['hig'].values,
                                         ))
#         print("hourly_attribute: " ,hourly_attribute)
    else:
        hourly_attribute=[np.nan,np.nan,np.nan,np.nan,np.nan,np.nan,np.nan,np.nan,np.nan,np.nan,np.nan,np.nan]
