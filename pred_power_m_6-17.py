...
def split_data(data):
    feature_data = pd.DataFrame(data,columns=['up_Power_1','up_Power_2','up_Power_3','up_Radiation_1','now_Radiation'])
    length_data = len(data)
    length_data_last = length_data-3
...
for i in range(1):
    feature_data = ['up_Power_1','up_Radiation_1','now_Radiation']
#     #使用基線模型時只能套單欄位
